...
public class ServerFacade extends Endpoint {
   ...
   // Thread messageScanner = new Thread();
    ...
    public void webSocket(String authToken, int gameID, TeamColor color, String username) throws ServerFacadeException {
        try {
            session = WSEndPoint.connectToServer(this, URI.create("ws://DESKTOP-957S9DI:8080/connect"));
            messageHandler = new ClientWebSocketHandler(username);
    ...
    public boolean prevMoveMsgAvailable() {
        return messageHandler.prevMoveMsgAvailable();
    }
 ...
 /*   public ClientWebSocketHandler getMsgHandler() throws ServerFacadeException {
    ...
    public ArrayList<String> getOldMoves() throws ServerFacadeException {
        return messageHandler.getOldMoveMsgs();
    }
}
